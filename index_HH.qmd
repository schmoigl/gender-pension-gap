    ...
    .encode( 
      ...
      vl.x()
        ...
        .axis({
          ...
          ticks: false,
          labelAlign: "right",
          labelPadding: 20,  // Adjusted padding
  ...
  const text = vl
    ...
    .encode(
      vl.y()
        .fieldQ("value")
        .axis({
          format: "+.2%"  // Ensure format is set here for text
        }),
      vl.x()
        .fieldN("detail"),
      vl.text()
        .fieldQ("value")
        .format("+.2%"),  // Format the text as percentages
    )
    ...
    .encode( 
      vl.y()
        ...
        .axis({
          title: null,
          grid: false,
          format: "+.2f",  // Format for y-axis labels as percentages
        }),
      vl.x()
        .fieldN("detail")
        .axis({
...
barsIncomeG = {
  ...
  const bars = vl
    ...
    .encode( 
      ...
      vl.color()
        .condition(
          { test: (datum) => datum.detail === radioRaw, value: colors[1] },  // Prüft, ob die Detailspalte mit der Auswahl übereinstimmt
          { value: "grey" }  // Standardfarbe für nicht ausgewählte Gruppen
        )
    )
