...
barsText = diffScenario != 0 ? 
  ...
  "Im " + select + " würden " + radio + " mit einer Pension von " + d3.format(".0f")(statusIncome) + checkText1 + checkText2 + " gleich viel erhalten wie aktuell. " + "Das Szenario hätte keinen Effekt. " 
```
