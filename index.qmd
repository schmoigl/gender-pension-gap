...
<div class="image-container"> <img src="img/WIFO_6333.jpg"> </div>
...
::: {.column width="50%"}
```{ojs}
bars(width > 600 ? 250 : width * 0.4).render({ renderer: "svg" })
```
:::
...
<button id="jumpToLastBtn" class="btn btn-secondary small-btn">Überspringen und zum vollen Tool</button>
...
<script>
  ...
  function updateButtonStates() {
    ...
    if (currentSlide < 2) {
      ...
      jumpToLastBtn.style.display = 'inline-block'; // Show "Jump to last page" button
    } else {
