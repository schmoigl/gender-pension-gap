...
hhIncome = aq.from(hhIncomeRaw)
  ...
  .derive({ 
    ...
    group2: d => d.group != "Haushaltstyp - detailiert" ? "irrelevant" : (d.detail.includes("kein Kind") ? "Kein Kind" : "Kinder"),
    // radioHaushaltseffekt: aq.escape(d => radioHaushaltseffekt),
    ...
    radioKinder: aq.escape(d => radioKinder),
    radioErwachsene: aq.escape(d => radioErwachsene),
    // focus: d => d.radioGeschlecht || d.selectStatus || d.radioAltersgruppe,
    })
  .objects()
