...
bars = {
  ...
  return layers
    .height(width > 600 ? 280 : 180) // width > 825 ? 280 : 180 
    .width(width > 600 ? 310 : width * 0.8)
    // .facet({
    //   field: "D", 
    //   type: "nominal", 
    //   title: null,
    ...
    .data(
      deciles
        ...
        .filter(d => d.gesl == d.radio || d.D == "Bezugsgruppe")
        .map(d => ({...d, gesl: d.gesl == d.radio && d.D == "Bezugsgruppe" ? "Bezugsgruppe" : "∅ " + d.gesl}))
    )
    .config(config)
    .render({ renderer: "svg" })
...
```
${distributionsChangeText1} ${distributionsChangeText2} 
:::
