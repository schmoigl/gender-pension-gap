...
<button class="btn btn-secondary" style="margin-top: 30px; margin-bottom: 50px;" onclick="jumpToSlide(10)">Weiter und herausfinden, wie sich Armutsgefährdungsquote und Einkommen verändern</button>
...
${radioHaushaltseffekt === "das Gesamteinkommen meines Haushalts" ? hhIncomeGeschlechttext : hhPovertyGeschlechttext} <br><br>
...
## Das sind Ihre Ergebnisse
#### Ergebnisse 2/3
<span>Wie würde sich das ${select} auf die ${optionHH} in ihrer Altersgruppe auswirken?</span>
...
<script>
  ...
  function updateButtonStates() {
    ...
    if (currentSlide === 9) {
      ...
      nextBtn.textContent = 'Pensionsfairness-Rechner starten';
