...
<div class="image-container"> <img src="img/AdobeStock_670701322.jpeg"> </div>
...
barsText = 
  ...
  "Im " + select + " würden vergleichbere " + radio + " mit einer Pension von " + d3.format(",.0f")(statusIncome) + " Euro (" + deciles.map(d => d.closestDecileValue)[0] + " der " + radio + ")" + checkText1 + checkText2 + " im Schnitt um " + d3.format(",.0f")(diffScenario) + " Euro mehr Pension erhalten. Das entspricht etwa " + d3.format(",.0%")(diffScenarioPerc) + " mehr. Betrachtet man den Gesamtdurchschnitt aller "+ radio + checkText1 + checkText2 + " so würden diese im Schnitt " + d3.format(",.0f")(diffScenarioGesamt) + " Euro oder " + d3.format(",.0%")(diffScenarioPercGesamt) + " mehr Pension bekommen." :
  diffScenarioGesamt < 0 ?
  "Im " + select + " würden vergleichbere " + radio + " mit einer Pension von " + d3.format(",.0f")(statusIncome) + " Euro (" + deciles.map(d => d.closestDecileValue)[0] + " der " + radio + ")" + checkText1 + checkText2 + " im Schnitt um " + d3.format(",.0f")(diffScenario) + " Euro mehr Pension erhalten. Das entspricht etwa " + d3.format(",.0%")(diffScenarioPerc) + " mehr. Betrachtet man den Gesamtdurchschnitt aller "+ radio + checkText1 + checkText2 + " so würden diese im Schnitt " + d3.format(",.0f")(-diffScenarioGesamt) + " Euro oder " + d3.format(",.0%")(-diffScenarioPercGesamt) + " weniger Pension bekommen." : 
...
"Die mittlere Pension der Männer würde sich nicht verändern und bei " + d3.format(",.0~f")(bins.filter(d => d.variable == select && d.gesl == d.radio)[0].median) + " verbleiben." :
"Die mittlere Pension der " + radio + " würde sich auf " + d3.format(",.0~f")(bins.filter(d => d.variable == select && d.gesl == d.radio)[0].median) + " Euro steigern."
```
