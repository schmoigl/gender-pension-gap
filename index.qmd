...
¹Datenbasis: Pensionsversicherungs-Jahresstatistik (PJ), Dezember 2023 Berechnung: MA 23 - Wirtschaft, Arbeit und Statistik der Stadt Wien
:::
...
<span>Zutreffendes ankreuzen (falls relevant)</span>
...
distributionsChange = {
  ...
  const textGrayVar = radio == "Frauen" || select == "Szenario 2 (Arbeitslosigkeit)" || select == "Szenario 5 (Beste 15 Jahre)"  ? "neue mittlere Pension" : "mittlere Pension"
...
<span>Hier können Sie die Studienergebnisse gesammelt betrachten und Ihre Eingaben ändern</span>
...
<div class="fold-container">
  <div class="column">
      ...
      Inputs.bind(Inputs.range([400, 4000], {step: 50, value: 1500}), viewof rangeRaw) 
      Inputs.bind(Inputs.radio(["Frauen", "Männer"], {value: "Frauen"}), viewof radio) 
      Inputs.bind(Inputs.radio(["Vergleichsgruppe", "∅ Durchschnitt"], {value: "Vergleichsgruppe", label: ""}), viewof radio2)
      ```
  </div>
