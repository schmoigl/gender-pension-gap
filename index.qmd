...
infoHH = haushaltseffekt === "Haushaltseinkommen" ? 
  html`
...
## Das sind Ihre Ergebnisse
#### Ergebnisse 1/3
<span>Wie würde sich das ${select} auf die ${haushaltseffekt} von ${radio} auswirken?</span>
...
${haushaltseffekt === "Haushaltseinkommen" ? hhIncomeGeschlechttext : hhPovertyGeschlechttext} <br><br>
...
## Das sind Ihre Ergebnisse
#### Ergebnisse 2/3
<span>Wie würde sich das ${select} auf die ${haushaltseffekt} in ihrer Altersgruppe auswirken?</span>
...
${haushaltseffekt === "Haushaltseinkommen" ? hhIncomeAltersgruppetext : hhPovertyAltersgruppetext} <br><br>
...
```{ojs}
haushaltseffekt === "Haushaltseinkommen" ?
  generateIncomeChartStatusquo("Erwerbsstatus").render({ renderer: "svg" }) : generatePovertyChartStatusquo("Erwerbsstatus").render({ renderer: "svg" })
```
...
${haushaltseffekt === "Haushaltseinkommen" ? hhIncomeStatustext : hhPovertyStatustext} <br><br>
