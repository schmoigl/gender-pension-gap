...
::: {.slide}
#### Ergebnisse 3/4
<span>Wie viel Pension bekomme ich momentan im Vergleich zu anderen?</span>
...
distributionsChange = {
  ...
  const textNew = vl
    .markText({
      // opacity: 0.51,
      clip: true,
      size: radio == "Frauen" || select == "Szenario 2 (Arbeitslosigkeit)" || select == "Szenario 5 (Beste 15 Jahre)"  ? 11 : 0,
      y: 180,
      align: "left",
    })
    .data([
